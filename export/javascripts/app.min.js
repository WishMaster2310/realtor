...
$(function(){function s(){var s=$("#switcher0001");s.prop("checked")?(s.prop("checked",!1),$('.c-tabs__link[data-type="sell"]').addClass("c-tabs__link--active").siblings().removeClass("c-tabs__link--active"),$('.c-tabs__unit[data-type="sell"]').stop(!0,!0).fadeIn(300),$('.c-tabs__unit[data-type="buy"]').stop(!0,!0).fadeOut(300)):(s.prop("checked",!0),$('.c-tabs__link[data-type="buy"]').addClass("c-tabs__link--active").siblings().removeClass("c-tabs__link--active"),$('.c-tabs__unit[data-type="buy"]').stop(!0,!0).fadeIn(300),$('.c-tabs__unit[data-type="sell"]').stop(!0,!0).fadeOut(300))}$(".c-slider").slick({dots:!0,infinite:!1,prevArrow:"<div class='c-slider__arrow c-slider__arrow--prev'></div>",nextArrow:"<div class='c-slider__arrow c-slider__arrow--next'></div>",autoplay:!0,autoplaySpeed:4e3,responsive:[{breakpoint:1005,settings:{arrows:!1}},{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1}}]}),$(".c-media__list").each(function(){$(this).slick({dots:!1,infinite:!1,prevArrow:"<div class='c-media__arrow c-media__arrow--prev'></div>",nextArrow:"<div class='c-media__arrow c-media__arrow--next'></div>",slidesToShow:3,slidesToScroll:3,adaptiveHeight:!0,autoplay:!0,autoplaySpeed:4e3,responsive:[{breakpoint:1005,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0}}]})}),$(".c-feeds__list").slick({dots:!1,infinite:!1,prevArrow:"<div class='c-feeds__arrow c-feeds__arrow--prev'></div>",nextArrow:"<div class='c-feeds__arrow c-feeds__arrow--next'></div>",slidesToShow:3,slidesToScroll:3,adaptiveHeight:!0,autoplay:!0,autoplaySpeed:4e3,responsive:[{breakpoint:1005,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0}}]}),$(".c-tabs__link").on("click",function(){$(this).hasClass("c-tabs__link--active")||s()}),$(".js-scrollto").on("click",function(s){s.preventDefault();var e=$($(this).attr("href"));$("html, body").animate({scrollTop:e.offset().top},400)}),$(".c-nav__burger").on("click",function(){$("body").toggleClass("--nav-open")}),$('input[type="tel"]').mask("+7 (999) 999-99-99");var e=!0;$(window).on("scroll",function(){if(e){var s=$(this).height(),i=$(".c-conditions"),t=i.offset().top;console.log($(this).scrollTop(),s,t),$(this).scrollTop()>t-s&&($(".c-conditions__item").each(function(s,e){setTimeout(function(){$(e).addClass("c-conditions__item--active")},400*(s+1))}),i.addClass("c-conditions--animated"),e=!1)}})});